...
module.exports = function (window) {
    ...
    var NS = require('./vdom-ns.js')(window),
         ...
         * @param createVElement {Funtion} import from v-element.js
         ...
         * @since 0.0.1
         */
        domNodeToVNode = function(domNode, createVElement, parentVNode) {
            ...
            // set properties:
            vnode.vElement = createVElement(domNode);
                ...
                if (!vnode.isVoid) {
                    ...
                    if (NS.SCRIPT_OR_STYLE_TAG[tag]) {
                        ...
                        for (i=0; i<len; i++) {
                            ...
                            childVNode = domNodeToVNode(domChildNode, createVElement, vnode);
