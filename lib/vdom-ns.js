...
module.exports = function (window) {
    ...
    /**
     * Reference to the ExtElement of document.body (gets its value as soon as it gets refered to)
     *
     * @property body
     * @default null
     * @type ExtElement
    ...
    /**
     * A hash with all node'ids (of all the domnodes that have an id). The value is a reference to an ExtElement.
     *
     * @property nodeids
     * @default {}
     * @type Object
