    ...
    var vNodeProto = require('./vnode.js')(window),
        ...
        htmlToVNodes = function(htmlString) {
            var i = 0,
                ...
                j, character, character2, vnode, isBoolean, classNames, checkBoolean, classes, len2, childNodes, childNode, children;
...
/*jshint boss:false */
                    ...
                    if (!vnode.isVoid) {
                        ...
                        if (NS.SCRIPT_OR_STYLE_TAG[vnode.tag]) {
                            ...
                            childNodes = vnode.childNodes = htmlToVNodes(innerText, vnode);
                            children = vnode.children = [];
                            len2 = childNodes.length;
                            for (j=0; j<len2; j++) {
...
/*jshint boss:true */
                        else if (vnode.isVoid=(new RegExp('</'+vnode.tag+'>', 'i').test(htmlString))) {
/*jshint boss:false */
                            voidElements[vnode.tag] = true;
                        }
