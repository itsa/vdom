...
/*jshint boss:false */
                        case 1: // oldNodeType==Element, newNodeType==Element
                            if ((oldChild.tag!==newChild.tag) || ((oldChild.tag==='SCRIPT') && (oldChild.text!==newChild.text))) {
                                ...
                                newChild.attrs = oldChild.attrs; // set to current state, to force defined by `_setAttrs`
                                newChild.vChildNodes = oldChild.vChildNodes; // set to current state, to force defined by `_setAttrs`
                                ...
                                // newChild.attrs = bkpAttrs;
                                // newChild.vChildNodes = bkpChildNodes;
