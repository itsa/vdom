    ...
    vNodeProto = {
        ...
        */
        ...
        _appendChild: function(VNode) {
            ...
            instance.domNode._appendChild(VNode.domNode);
        },
        ...
        _insertBefore: function(newVNode, refVNode) {
            ...
            if (index!==-1) {
                ...
                instance.domNode._insertBefore(newVNode.domNode, refVNode.domNode);
            }
        },

        _removeChild: function(VNode) {
            VNode._remove();
            this.domNode._removeChild(VNode.domNode);
        },

        _replaceChild: function(newDomVNode, oldDomVNode) {
            oldDomVNode._replaceAtParent(newDomVNode);
            this.domNode._replaceChild(newDomVNode.domNode, oldDomVNode.domNode);
        },
        ...
        */
        _moveToParent: function(parentVNode, index) {
            ...
            index ? parentVNode.vChildNodes.insertAt(instance, index) : (parentVNode.vChildNodes[parentVNode.vChildNodes.length]=instance);
            // force to recalculate the vChildren on a next call:
