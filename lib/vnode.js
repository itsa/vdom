...
module.exports = function (window) {
    ...
    var NS = require('./vdom-ns.js')(window),
        ...
        _matchesSelectorItem, _matchesOneSelector, _findElementSibling, vNodeProto, _findNodeSibling, _findFromAll;
    ...
    vNodeProto = {
        ...
        */
        store: function() {
            ...
            var instance = this;
            if (instance.vElement) {
                instance.vElement.domNode && nodesMap.set(instance.vElement.domNode, instance);
        ...
        */
        _checkNewChildren: function() {
            // getting .vnode will create and insert new vNodes when they are not present yet
            var instance = this,
        ...
        */
        _deleteFromParent: function() {
            ...
            (instance.nodeType===1) && (instance.vParent._vChildren=null);
            return instance;
        },

       /**
        * Regenerates the life `childNodes`-property
        *
        * @method _generateChildNodes
        * @private
        * @chainable
        * @since 0.0.1
        */
        _generateChildNodes: function() {
            var instance = this,
                vChildNodes = instance.vChildNodes,
                i, len;
            if (vChildNodes) {
                if (instance._childNodes) {
                    instance._childNodes.length = 0;
                }
                else {
                    instance._childNodes = ElementArray.createArray();
                }
                len = vChildNodes.length;
                for (i=0; i<len; i++) {
                    instance._childNodes[i] = vChildNodes[i].vElement;
                }
            }
            return instance;
        },
       ...
       /**
        * Regenerates the life `children`-property
        *
        * @method _generateChildren
        * @private
        * @chainable
        * @since 0.0.1
        */
        _generateChildren: function() {
            ...
            if (vChildren) {
                if (instance._children) {
                    instance._children.length = 0;
                }
                else {
                    instance._children = ElementArray.createArray();
                }
                len = vChildren.length;
                for (i=0; i<len; i++) {
                    instance._children[i] = vChildren[i].vElement;
                }
            }
            return instance;
        },
...
/*jshint boss:false */
        ...
        * @param [fromInternal] {Boolean} set when this method is called from inside itself
        * @private
        * @chainable
        * @since 0.0.1
        */
        _setChildNodes: function(newVChildNodes, fromInternal) {
            // does sync the DOM
            var instance = this,
                vChildNodes = instance.vChildNodes,
                vElement = instance.vElement,
...
/*jshint boss:false */
                        case 1: // oldNodeType==Element, newNodeType==Element
                            if ((oldChild.tag!==newChild.tag) || ((oldChild.tag==='SCRIPT') && (oldChild.text!==newChild.text))) {
                                ...
                                newChild._setChildNodes(newChild.vChildNodes, true);
                    ...
                    oldChild._remove();
                    vElement._removeChild(oldChild.vElement);
                }
            }
            ...
            !fromInternal && instance._childNodes && instance._generateChildNodes();
            !fromInternal && instance._children && instance._generateChildren();
            return instance;
        }
    ...
    Object.defineProperties(vNodeProto, {
        ...
        childNodes: {
            get: function() {
                var instance = this;
                instance._childNodes || instance._generateChildNodes();
                return instance._childNodes;
            }
        },
        ...
        children: {
            get: function() {
                var instance = this;
                instance._children || instance._generateChildren();
        ...
        innerHTML: {
            ...
            set: function(v) {
console.warn(htmlToVNodes(v, vNodeProto));
        ...
        outerHTML: {
            ...
            set: function(v) {
                ...
                vnode = htmlToVNodes(v, vNodeProto);
                if (vnode.nodeType===1) {
        ...
        textContent: {
            ...
            set: function(v) {
                ...
                if (vChildNodes) {
                    ...
                    for (i=0; i<len; i++) {
                        vChildNode = vChildNodes[i];
                        vElement._removeChild(vChildNode.vElement.domNode);
                        vChildNode._remove();
                    }
                    instance._childNodes && instance._generateChildNodes();
                    instance._children && instance._generateChildren();
