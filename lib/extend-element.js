...
module.exports = function (window) {
     ...
     * @since 0.0.1
     */
    Object.defineProperty(Node.prototype, 'vnode', {
       get: function() {
            var instance = this,
    ...
    (function(ElementPrototype) {
        ...
        */
        ElementPrototype.hasClass = function(className) {
            return this.getCassList().contains(className);
        };
        ...
        */
        ...
        ElementPrototype.removeAttribute = function(attributeName) {
            ...
            vnode && (delete vnode.attrs[attributeName]);
        };
        ...
        */
        ElementPrototype.removeClass = function(className) {
            var instance = this;
            instance.getCassList().remove(className);
            return instance;
        };
        ...
        */
        ...
        ElementPrototype.setAttribute = function(attributeName, value) {
            ...
            if (value) {
                ...
                vnode && (vnode.attrs[attributeName]=value);
            }
            else {
        ...
        */
        ElementPrototype.setClass = function(className) {
            var instance = this;
            instance.getCassList().add(className);
            return instance;
        };
        ...
        */
        ElementPrototype.toggleClass = function(className, forceState) {
            var instance = this;
            instance.getCassList().toggle(className, forceState);
            return instance;
        };
