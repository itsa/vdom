...
module.exports = function (window) {
    ...
    (function(ElementPrototype) {
        ...
        */
        ElementPrototype.append = function(content, refElement, escape) {
            ...
            if (Array.isArray(content)) {
                ...
                vChildNodes = content.vChildNodes;
                len = vChildNodes.length;
                for (i=1; i<len; i++) {
                    vFragment = vChildNodes[i];
                    vFragment.textContent = vFragment.innerHTML;
                    doAppend(vFragment.domNode);
                }
            }
            else {
                doAppend(content);
        ...
        ElementPrototype.appendChild = function(domNode) {
            this.vnode._appendChild(domNode.vnode);
        };
       ...
       /**
        ...
        ElementPrototype.insertBefore = function(domNode, refDomNode) {
            this.vnode._insertBefore(domNode.vnode, refDomNode.vnode);
        };
        ...
        */
        ...
        ElementPrototype.replaceChild = function(newDomNode, oldDomNode) {
            this.vnode._replaceChild(newDomNode.vnode, oldDomNode.vnode);

            var instance = this,
                vnode = instance.vnode;
            vnode._noSync();
            oldDomNode.vnode._replaceAtParent(newDomNode.vnode);
            instance._replaceChild(newDomNode, oldDomNode);
        };
