...
module.exports = function (window) {
    ...
    window.Element && (function(ElementPrototype) {
        ...
        */
        ...
        ElementPrototype.getElementsByName = function(name) {
            return LIFE_NAMES[name] || (LIFE_NAMES[name]=DOCUMENT.querySelectorAll('[name="'+name+'"]'));
        };
        ...
        ElementPrototype.elementFromPoint = function(x, y) {
        };
        ...
        ElementPrototype.normalize = function(id) {
        };
    ...
    extendElement = function(element) {
        ...
        Object.defineProperties(Element, {
            ...
            // accessing the properties means: port them into the attributeSetter and getter
            // this concerns 'id', 'className', 'href', style', 'name' and...
            ...
            // Note that the name property doesn't exist on the other element. It is not a property of the Element or HTMLElement interface.
            name: {
                get: function() {
                }
            },
