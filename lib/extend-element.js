...
module.exports = function (window) {
            ...
            _init: function(vElement, whatToShow, filter) {
                ...
                searchChildNodes = function(vnode) {
                    var instance = this,
                        ...
                        vChildNode, i, hasMatch;
                    for (i=0; i<len; i++) {
                        vChildNode = vChildNodes[i];
                        hasMatch = match(vChildNode);
                        ((hasMatch===true) || (hasMatch===FILTER_ACCEPT)) && (instance.results[instance.results.length]=vChildNode.vElement);
                        (hasMatch!==FILTER_REJECT) && vChildNode.hasVChildNodes() && instance.searchChildNodes(vChildNode);
                    }
                },
                instance.pointer = -1;
                instance.results = [];
    ...
    window.Element && (function(ElementPrototype) {
       ...
       /**
        * Appends an Element, vElement,  or text at the end of HtmlElement's innerHTML, or before the `refElement`.
        *
        * @method append
        * @param content {Element|vElement|ElementArray|String} content to append
        * @param [refElement] {vElement} reference vElement where the content should be appended
        ...
        */
        ElementPrototype.append = function(content, refElement, escape) {
            ...
            doAppend = function(oneItem) {
                var childNodes, i, len, fragment;
                if (escape) {
                    if (oneItem.isFragment) {
                        childNodes = oneItem.childNodes;
                        ...
                        oneItem.textContent = oneItem.innerHTML;
                    }
                }
                if (refElement) {
         ...
         *
         * @method appendChild
         * @param element {Element|vElement|String} content to append
         * @return {vElement} the vElement that was appended
         */
        ...
        ElementPrototype.appendChild = function(element) {
            ...
            (typeof element===STRING) && (element=htmlToVFragments(element));
            if (element.isFragment) {
                ...
                element.domNode || (element=vElement(element));
                this._appendChild(element.domNode);
                element._repositionVNode();
                element._updateLifeLists();
            }
            return element;
        };
        ...
        * @return {vElement} a clone of this vElement
        * @since 0.0.1
        */
        ElementPrototype.cloneNode = function(deep) {
            var instance = this,
                cloned = instance.domNode.cloneNode(deep);
            cloned = vElement(cloned);
            cloned.vnode = domNodeToVNode(cloned, vElement);
         ...
         *     <li>Node.DOCUMENT_POSITION_PRECEDING  (this vElement comes before otherVElement)</li>
         *     <li>Node.DOCUMENT_POSITION_FOLLOWING  (this vElement comes after otherVElement)</li>
         *     <li>Node.DOCUMENT_POSITION_CONTAINS  (otherVElement trully contains -not equals- this vElement)</li>
         *     <li>Node.DOCUMENT_POSITION_CONTAINED_BY  (vElement trully contains -not equals- otherVElement)</li>
         * </ul>
         *
         * @method compareDocumentPosition
         * @param otherElement {vElement|Element}
         ...
         */
        ElementPrototype.compareDocumentPosition = function(otherVElement) {
            // see http://ejohn.org/blog/comparing-document-position/
            var instance = this,
                parent, index1, index2;
            if (instance===otherVElement) {
                return 0;
            }
            if (!DOCUMENT.contains(instance) || !DOCUMENT.contains(otherVElement)) {
                return 1;
            }
            else if (instance.contains(otherVElement)) {
                return 20;
            }
            else if (otherVElement.contains(instance)) {
                return 10;
            }
            parent = instance.parentNode;
            index1 = parent.childNodes.indexOf(instance);
            index2 = parent.childNodes.indexOf(otherVElement);
            if (index1<index2) {
                return 4;
            }
            else {
        ...
        /**
         * Indicating whether this vElement contains OR equals otherVElement.
         *
         * @method contains
         * @param otherElement {vElement|Element}
         * @return {Boolean} whether this vElement contains OR equals otherVElement.
         */
        ElementPrototype.contains = function(otherVElement) {
            ...
            return this.vnode.contains(otherVElement.vnode);
        };

        /**
         * Returns a new NodeIterator object with this vElement as root.
         *
        ...
        */
        ...
        /**
         * Returns a newly created TreeWalker object with this vElement as root.
         *
        ...
        * Alias for thisNode.textContent = '';
        *
        * @method empty
        * @chainable
        * @since 0.0.1
        */
         ...
         *
         * @method first
         * @param [cssSelector] {String} to return the first vElement that matches the css-selector
         * @return {vElement}
         * @since 0.0.1
         */
        ...
        /**
         * Reference to the first child-vElement, where the related dom-node an Element (nodeType===1).
         *
        ...
        ElementPrototype.firstOfChildren = function(cssSelector) {
            ...
            return vnode && vnode.firstOfVChildren(cssSelector).vElement;
        };
        ...
        * @param [ancestor] {vElement} the HtmlElement where it should be forced into its view.
       ...
       /**
        * Forces the vElement to be inside the window-view. Differs from `scrollIntoView()` in a way
        ...
        */
        ...
        /**
         * Gets an ElementArray of vElements that lie within this vElement and match the css-selector.
         *
         * @method getAll
       ...
       /**
        * Gets an attribute of the vElement.
        *
        ...
        * @method getElement
        * @param cssSelector {String} css-selector to match
        * @return {vElement|null} the HtmlElement that was search for
        * @since 0.0.1
        */
        ...
        /**
         * Returns an ElementArray of all vElements within this vElement, that match their classes with the supplied `classNames` argument.
        ...
        /**
         * Returns the vElement matching the specified id, which should should be a descendant of this vElement.
         *
        ...
        /**
         * Returns an ElementArray of all vElements within this vElement, that match their `name`-attribute with the supplied `name` argument.
         *
       ...
       /**
        * Indicating if the vElement has any children (childNodes with nodeType of 1).
        *
        * @method hasChildren
        * @return {Boolean} whether the vElement has children
        * @since 0.0.1
        */
       ...
       /**
        * Checks whether the className is present on the vElement.
        *
        * @method hasClass
        * @param className {String|Array} the className to check for. May be an Array of classNames, which all needs to be present.
        * @return {Boolean} whether the className (or classNames) is present on the vElement
        * @since 0.0.1
        */
       ...
       /**
        * If the vElement has data set specified by `key`. The data could be set with `setData()`.
        *
        * @method hasData
        * @param key {string} name of the key
        * @return {Boolean}
       ...
       /**
        * Indicates whether vElement currently has the focus.
        *
        * @method hasFocus
        * @return {Boolean}
        * @since 0.0.1
       ...
       /**
        * Inserts the vElement into the DOM tree at a specified position.
        *
        ...
        */
        ...
        ElementPrototype.insertBefore = function(newElement, refElement) {
            var i, childNodes, fragment, len;
            (typeof newElement===STRING) && (newElement=htmlToVFragments(newElement));
       ...
       /**
         * Checks whether the vElement lies within the specified selector (which can be a CSS-selector or a vElement)
         *
         * @example
         * var divnode = childnode.inside('div.red');
         *
         * @method inside
         * @param selector {vElement|String} the selector, specified by a vElement or a css-selector
         * @return {vElement|null} the nearest vElement that matches the selector, or `null` when not found
         * @since 0.0.1
         */
       ...
       /**
         * Checks whether a point specified with x,y is within the vElement's region.
         *
         * @method insidePos
         ...
         *
         * @method last
         * @param [cssSelector] {String} to return the last vElement that matches the css-selector
         * @return {vElement}
         * @since 0.0.1
         */
        ...
        /**
         * Reference to the last child-vElement, where the related dom-node an Element (nodeType===1).
         *
        ...
        ElementPrototype.lastOfChildren = function(cssSelector) {
            var vnode = this.vnode;
            return vnode && vnode.lastOfVChildren(cssSelector).vElement;
        };

        /**
         * Indicates if the element would be selected by the specified selector string.
         * Alias of matchesSelector()
         *
         * @method matches
        ...
        // don't document: it shouldn't be used
        ...
        *
        * @method prepend
        * @param content {Element|vElement|ElementArray|String} content to prepend
        * @param [refElement] {vElement} reference vElement where the content should be prepended
        * @param [escape] {Boolean} whether to insert `escaped` content, leading it into only text inserted
        * @chainable
        * @since 0.0.1
        */
        ...
        /**
         * Returns the first vElement within the vElement, that matches the CSS-selectors. You can pass one, or multiple CSS-selectors. When passed multiple,
        ...
        /**
         * Returns an ElementArray of all vElements within the vElement, that match the CSS-selectors. You can pass one, or multiple CSS-selectors. When passed multiple,
         * they need to be separated by a `comma`.
         *
       ...
       /**
         * Checks whether the vElement has its rectangle inside the outboud-Element.
         * This is no check of the DOM-tree, but purely based upon coordinates.
         *
         * @method rectangleInside
         * @param outboundElement {vElement} the Element where this element should lie inside
         * @return {Boolean} whether the vElement lies inside the outboundElement
         * @since 0.0.1
         */
       ...
       /**
        * Removes the vElement from the DOM.
       ...
       /**
        * Removes the attribute from the vElement.
        *
       ...
       /**
        * Removes the attribute specified by an attributeNode from the vElement.
        *
        ...
        */
        ElementPrototype.removeAttributeNode = function(attributeNode) {
            this.removeAttribute(attributeNode.name);
        };

       /**
        * Removes the vElement's child-vElement from the DOM.
        *
        * @method removeChild
        * @param childVElement {vElement} the child-vElement to remove
        * @since 0.0.1
        */
        ElementPrototype._removeChild = ElementPrototype.removeChild;
        ElementPrototype.removeChild = function(childVElement) {
            childVElement.domNode || (childVElement=vElement(childVElement));
            nodesMap.has(childVElement.domNode) && childVElement.vnode.remove();
            this._removeChild(childVElement.domNode);
            childVElement._updateLifeLists();
            // break the circular reference to prevent problems with GC:
            childVElement.domNode.vElement = null;
            return childVElement;
        };

       /**
        * Removes a className from the vElement.
        *
        * @method removeClass
       ...
       /**
        * Removes a css-property (inline) out of the vElement.
        ...
        *
        * @method replace
        * @param newVElement {vElement|String} the new vElement
        * @param [escape] {Boolean} whether to insert `escaped` content, leading it into only text inserted
        * @chainable
        * @since 0.0.1
        */
        ElementPrototype.replace = function(newVElement, escape) {
            var instance = this;
            escape && (newVElement.textContent=newVElement.innerHTML);
            instance.parentNode.replaceChild(instance, newVElement);
            return instance;
        };

       /**
        * Replaces the className of the vElement with a new className.
       ...
       /**
        * Replaces the vElement's child-vElement with a new vElement.
        *
        * @method replaceChild
        * @param newVElement {vElement|String} the new vElement
        * @param oldVChild {vElement} the vElement to be replaced
        * @return {vElement} the vElement that was removed (equals oldVChild)
        * @since 0.0.1
        */
        ElementPrototype._replaceChild = ElementPrototype.replaceChild;
        ElementPrototype.replaceChild = function(newVChild, oldVChild) {
            newVChild.domNode || (newVChild=vElement(newVChild));
            oldVChild.domNode || (oldVChild=vElement(oldVChild));
            nodesMap.has(oldVChild.domNode) && oldVChild.vnode.remove();
            this._replaceChild(newVChild.domNode, oldVChild.domNode);
            newVChild._repositionVNode();
            newVChild._updateLifeLists();
            oldVChild._updateLifeLists(true);
            oldVChild.domNode.vElement = null;
            return oldVChild;
        };
       ...
       /**
         * Sets the attribute on the vElement with the specified value.
         *
       ...
       /**
         * Sets the attribute on the vElement specified by `attributeNode`
         *
       ...
       /**
        * Adds a class to the vElement. If the class already exists it won't be duplicated.
        *
        * @method setClass
        ...
        */
        ...
        /**
         * Stores arbitary `data` at the vElement (actually at vnode). This has nothing to do with node-attributes whatsoever,
       ...
       /**
        * Sets a css-property (inline) out of the vElement. Use camelCase.
        *
        * Note: no need to camelCase cssProperty: both `margin-left` as well as `marginLeft` are fine
        *
        * @method setStyle
       ...
       /**
         ...
         *
         * If the vElement has the attribute `xy-constrian` set, then its position cannot exceed any matching container it lies within.
         *
         * @method setXY
         * @param x {Number} x-value for new position (coordinates are page-based)
         * @param y {Number} y-value for new position (coordinates are page-based)
         * @param [constrain] {'window', vElement, Object, String}
         * <ul>
         *     <li><b>'window'</b> to constrain to the visible window</li>
         *     <li><b>vElement</b> to constrain to a specified vElement</li>
       ...
       /**
        * Sets vElement's vnode to the right place inside its parent children.
        * Needs to be invoked after modification of the dom-children.
        *
        * @method _repositionVNode
        * @private
        * @chainable
        * @since 0.0.1
        */
        ElementPrototype._repositionVNode = function() {
            var instance = this,
...
/*jshint boss:false */
        ...
        /**
         * Updates the life properties `children` and `childNodes`.
         *
         * @method _updateLifeChildren
         * @private
         * @since 0.0.1
         */
        ElementPrototype._updateLifeChildren = function() {
            var vnode = this.vnode;
            vnode._childNodes && vnode._generateChildNodes();
            vnode._children && vnode._generateChildren();
        };
