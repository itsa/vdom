...
module.exports = function (window) {
    ...
    */
    ...
    Object.defineProperties(DOCUMENT, {
        ...
        'activeElement': {
            get: function() {
                var vnode = nodesMap.get(DOCUMENT._activeElement);
                return vnode ? vnode.vElement : vElement(DOCUMENT._activeElement);
            }
        },
        ...
        'currentScript': {
            get: function() {
                var vnode = nodesMap.get(DOCUMENT._currentScript);
                return vnode ? vnode.vElement : vElement(DOCUMENT._currentScript);
            }
        },
        ...
        'documentElement': {
            get: function() {
                var vnode = nodesMap.get(DOCUMENT._documentElement);
                return vnode ? vnode.vElement : vElement(DOCUMENT._documentElement);
            }
        },
        ...
        'title': {
            get: function() {
                var vnode = nodesMap.get(DOCUMENT._title);
                return vnode ? vnode.vElement : vElement(DOCUMENT._title);
            },
            set: function(val) {
                var vnode = nodesMap.get(DOCUMENT._title);
                DOCUMENT._title = val;
                vnode && (vnode.text=val);
            }
        }
    });
