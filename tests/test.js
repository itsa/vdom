...
(function (window) {
    ...
    describe('Classes and Promise return-values', function () {
        ...
        beforeEach(function() {
            ...
            node.setAttribute('style', 'position: absolute; z-index: 1; left: 20px; top: 200px; width: 100px; height: 100px;');
        ...
        it('setClass Transition delay and resolved promise from defined --> defined', function (done) {
            var delayed = false;
            node.setClass('red');
            node.setInlineTransition('background-color', 1, 'ease', 0);
            setTimeout(function() {
                delayed = true;
            }, 500);
            node.setClass('blue', true).then(
                function() {
